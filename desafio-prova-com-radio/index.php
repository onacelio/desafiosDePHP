...
<body>
        ...
        <main>
            <form action="gabarito.php" method="post" name="quiz">
                <?php 
                    $questoes = [
                        'Uma circuferência trigonométrica com os angulos M, N, P e Q, respectivamente cada um representando o 1°, 2°, 3° e 4° quadrante tem a medida dos ângulos como: 
                        M = a;
                        N = 90° + b;
                        P = 70° + 3a + b;
                        Q = ?
                        Qual a medida associada ao angulo Q?',
